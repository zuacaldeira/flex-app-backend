 ...
 */
public abstract class GraphRelationship implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other instanceof GraphRelationship) {
            GraphRelationship otherEntity = (GraphRelationship) other;
