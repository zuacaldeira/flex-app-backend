...
public class Neo4jQueries {
    ...
    public  String findSourceBySourceId(String sourceId) {
        return findQuery(NewsSource.class.getSimpleName(), "sourceId", BackendUtils.getInstance().wrapUp(sourceId));
    }
    
    public  String findArticleByTitle(String title) {
        return findQuery(NewsArticle.class.getSimpleName(), "title", BackendUtils.getInstance().wrapUp(title));
    }
    
    public  String findAuthorByName(String name) {
        return findQuery(NewsAuthor.class.getSimpleName(), "name", BackendUtils.getInstance().wrapUp(name));
    }
