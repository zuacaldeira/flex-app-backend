...
public abstract class AbstractDBService<T extends GraphEntity> implements DBService<T> {
    ...
    public final T find(T object) {
        try {
            ...
            query += " WHERE n." + object.getPropertyName() + "=" + BackendUtils.getInstance().wrapUp(object.getPropertyValue());
            query += " RETURN n";
            Session session = Neo4jSessionFactory.getInstance().getNeo4jSession();
    ...
    protected String getCreateStateQuery(String relationName, String userProperty, String userPropertyValue, String entityProperty, String entityPropertyValue) {
            ...
            query += "u." + userProperty   + "=" + BackendUtils.getInstance().wrapUp(userPropertyValue);
            query += " AND ";
            query += "n." + entityProperty + "=" + BackendUtils.getInstance().wrapUp(entityPropertyValue);
    ...
    protected String getMatchStateQuery(String relationName, String username, String property, String value, int limit) {
            ...
            query += "u.username=" + BackendUtils.getInstance().wrapUp(username);
            if(property != null) {
                query += " AND ";
                query += "n." + property + "=" + BackendUtils.getInstance().wrapUp(value);
            }
            query += " RETURN n";
    ...
    protected String getFindAllQuery(String username, String property, Object value, SortOrder order, int limit) {
        ...
        if(username != null && property != null) {
            ...
            if(value != null) {
                query += "AND n." + property + "=" + BackendUtils.getInstance().wrapUp(value.toString()) + " ";
            }
            else {
            ...
            if(value != null) {
                query += "WHERE n." + property + "=" + BackendUtils.getInstance().wrapUp(value.toString()) + " ";
            }
            else {
