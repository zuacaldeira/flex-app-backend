...
public class NewsSourceService extends AbstractDBService<NewsSource> {
    ...
    /**
     * Finds a {@code NewsSource} with a given source id.
     *
     * @param sourceId identifier of the news source
     * @return a {@code NewsSource} object with information regarding a single
     * Publisher.
     */
    ...
    /**
     * Finds a {@code NewsSource} with a given name.
     *
     * @param name of the news source
     * @return a {@code NewsSource} with that exact name.
     */
